...
export default function AgentWithdrawals({ auth, withdrawals, walletBalance, minimumWithdrawal, earningsBreakdown }: AgentWithdrawalsProps) {
                        ...
                        <form onSubmit={handleWithdrawal} className="space-y-6">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                                        <div className="flex justify-between items-center mb-2">
                                            ...
                                            <span className="text-sm font-bold text-gray-800 dark:text-gray-200">GHS {minimumWithdrawal.toFixed(2)}</span>
                                        </div>
                                        <div className="flex justify-between items-center mb-2">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <Button 
                                        type="submit" 
                                        disabled={processing || !data.amount || !data.network || !data.mobile_money_account_name || !data.mobile_money_number || Number(data.amount) < minimumWithdrawal || Number(data.amount) > (earningsBreakdown?.total_available || 0)}
